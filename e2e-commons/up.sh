...
while [ "$1" != "" ]; do
  ...
  if [ "$1" == "native-to-erc" ]; then
    ../deployment-e2e/molecule/molecule.sh ultimate-native-to-erc
  fi

  if [ "$1" == "erc-to-native" ]; then
    ../deployment-e2e/molecule/molecule.sh ultimate-erc-to-native
  fi

  if [ "$1" == "erc-to-erc" ]; then
    ../deployment-e2e/molecule/molecule.sh ultimate-erc-to-erc
  fi
