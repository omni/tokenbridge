...
docker-compose run -d bridge-amb yarn watcher:signature-request
docker-compose run -d bridge-amb yarn watcher:collected-signatures
docker-compose run -d bridge-amb yarn watcher:affirmation-request
