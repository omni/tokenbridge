...
const ORACLE_HOME_GAS_PRICE_UPDATE_INTERVAL = process.env.REACT_APP_UI_HOME_GAS_PRICE_UPDATE_INTERVAL
...
const ORACLE_FOREIGN_GAS_PRICE_UPDATE_INTERVAL = process.env.REACT_APP_UI_FOREIGN_GAS_PRICE_UPDATE_INTERVAL
