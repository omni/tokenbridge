...
class RootStore {
  ...
  @action
  async setBridgeMode() {
    const homeWeb3 = getWeb3Instance(process.env.COMMON_HOME_RPC_URL)
    const homeBridge = new homeWeb3.eth.Contract(HOME_ERC_TO_ERC_ABI, process.env.COMMON_HOME_BRIDGE_ADDRESS)
