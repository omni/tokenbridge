...
export const ConfirmationsContainer = ({ message, receipt, fromHome, timestamp }: ConfirmationsContainerParams) => {
  ...
  const { status, executionData, signatureCollected, waitingBlocksResolved } = useMessageConfirmations({
    message,
    receipt,
    fromHome,
    timestamp,
  ...
  return (
    <div className="row is-center">
      <StyledConfirmationContainer className="col-9">
        ...
        />
        {signatureCollected && (
          <ExecutionConfirmation messageData={message.data} executionData={executionData} isHome={!fromHome} />
        )}
